...
WARNING(W_EOF_IN_MACRO_ARGUMENT_LIST,      WG_SYNTAX,  WSTATE_WARN)    /*< . */
...
WARNING(W_STRING_TERMINATED_BY_EOF,        WG_STRING,  WSTATE_WARN)    /*< . */
...
WARNING(W_EXPECTED_INCLUDE_STRING,         WG_SYNTAX,  WSTATE_WARN)    /*< . */
