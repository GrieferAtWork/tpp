...
#define TPPLEXER_RESET_COUNTER    0x00000080 /* Clear all '#pragma once' descriptors and __COUNTER__/__TPP_COUNTER positions. */
#define TPPLEXER_RESET_FONCE      0x00000100 /* Reset __COUNTER__ and __TPP_COUNTER for all keywords. */
